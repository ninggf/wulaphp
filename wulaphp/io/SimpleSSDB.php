...
class SSDB {
     ...
     * @throws \wulaphp\io\SSDBTimeoutException
     */
    function exec() {
        $ret = [];
    ...
    /**
     * @return bool|null|SSDB_Response|\wulaphp\io\SSDB
     * @throws \Exception
     */
    function request() {
        $args = func_get_args();
    ...
    /**
     * @param                               $cmd
     * @param \wulaphp\io\SSDB_Response     $resp
     *
     * @return bool|null|\wulaphp\io\SSDB_Response
     */
     ...
     * @param array $kvs
     *
     * @return bool|null|\wulaphp\io\SSDB|\wulaphp\io\SSDB_Response
     * @throws \wulaphp\io\SSDBException
     */
     ...
     * @param $params
     *
     * @return \wulaphp\io\SSDB_Response
     * @throws \wulaphp\io\SSDBException
     * @throws \wulaphp\io\SSDBTimeoutException
     */
