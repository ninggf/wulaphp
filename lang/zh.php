...
return [
    ...
    'Function'                                                                => '函数',
    'Location'                                                                => '位置',
    'The count of parameters of "%s" does not match, expect %s but %s given.' => '"%s"只能接收%s个参数，但是实际接收到了%s个',
    '%s is not instance of wulaphp\mvc\Controller'                            => '"%s"没有继承wulaphp\mvc\Controller',
    'The $layout property of %s is not found'                                 => '"%s"未定义"$layout"属性',
    'The redis extension is not installed'                                    => 'redis扩展未安装',
    'Please give me a template file to render'                                => '未指定模板文件',
    'The template %s is not found'                                            => '模板文件"%s"不存在',
    'No route for %s'                                                         => '无法路由"%s"',
    'the namespace of %s cannot be wulaphp'                                   => '模块"%s"不能使用wulaphp做为命名空间',
    'The namespace "%s" of %s is invalid'                                     => '"%s"的命名空间"%s"不合法',
    'error occurred'                                                          => '出错啦',
    'Please login'                                                            => '请登录',
